...
if ($test_taken) {
    $matches_sql = "SELECT u.id, u.name, p.profile_pic, p.bio, p.major, p.interests,
               ...
               CASE WHEN LOWER(IFNULL(cr.interests, '')) COLLATE utf8mb4_unicode_ci LIKE CONCAT('%', LOWER(IFNULL(?, '')), '%') THEN 40 ELSE 0 END) as compatibility_score
                        ...
                        <div class="menfess-card sent">
                            ...
                            <div class="menfess-actions">
                                <div class="menfess-status">
                                    <?php if ($menfess['liked']): ?>
                                    <span class="liked-status">
                                        <i class="fas fa-heart"></i> Disukai oleh penerima
                                    </span>
                                    <?php else: ?>
                                    <span class="pending-status">
                                        <i class="far fa-clock"></i> Menunggu respon
                                    </span>
                                    <?php endif; ?>
                                </div>
                            </div>
